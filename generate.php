        ...
        <div class="col-xs-12">
            ...
            <div class="row">
                <div class="col-xs-4 myframe">
                    ...
                    <form role="form" action="generate.php" method="post">
                        ...
                        <div class="form-group">
                            <label for="state">Crud Operation:</label>
                            <?php
                            $operation = array("insert", "delete", "update");
                            $arrlength = count($operation);
                            ?>
                            <select class="form-control" name="op" disabled>
                                <option>Select an operation...</option>
                                <?php
                                for ($i = 0; $i < $arrlength; $i++) {
                                    echo '<option value="' . $operation[$i] . '">' . $operation[$i] . '</option>';
                                }
                                ?>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="field2" placeholder="field name"/>
                        </div>
